        ...
        <div className="p-2 sm:p-4 md:p-6 lg:p-8 space-y-8 md:space-y-12">
            ...
            {!isLoadingDebrief && selectedLaunch && (
                <div className="space-y-12">
                    {/* Seção 1: Resumo */}
                    <section>
                        <SectionHeader icon={Database} title="Resumo Geral" />
